...
import 'package:esp_provisioning/src/proto/dart/constants.pb.dart';
import 'package:esp_provisioning/src/proto/dart/session.pb.dart';
import 'package:esp_provisioning/src/proto/dart/wifi_config.pb.dart';
import 'package:esp_provisioning/src/proto/dart/wifi_scan.pb.dart';
...
class EspProv {
  ...
  Future<Uint8List> sendReceiveCustomData(Uint8List data,
    ...
    var i = data.length;
    var offset = 0;
    List<int?> ret = new List<int?>.filled(0, null);
    while (i > 0) {
